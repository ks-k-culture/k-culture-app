    ...
    <View className="flex-1 bg-black">
      <SafeAreaView className="flex-1" edges={["top"]}>
        <View className="flex-row items-center justify-between px-4 py-4">
          ...
          <Text className="text-white text-lg font-bold">{userName}님의 스파크</Text>
          <Pressable onPress={() => router.push("/spark-ranking")} className="p-2 -mr-2">
        ...
        <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false}>
          ...
          >
            <View className="flex-row items-center justify-between mb-6">
              <Text className="text-white text-lg font-bold">{userName}님의 스트릭</Text>
            ...
            <View className="flex-row">
              <View className="flex-1 items-center">
                <Text className="text-white text-3xl font-bold">0일</Text>
                <Text className="text-purple-200 text-sm mt-1">연속 스트릭</Text>
              </View>
              <View className="w-px bg-white/30" />
              <View className="flex-1 items-center">
                <Text className="text-white text-3xl font-bold">0개</Text>
          ...
          <View className="bg-[#1A1A1A] rounded-2xl p-4 mt-4">
            <View className="flex-row items-center justify-between">
              <Text className="text-white text-lg font-bold">365일간의 기록</Text>
          ...
          <View className="bg-[#1A1A1A] rounded-2xl p-5 mt-4">
            <View className="flex-row items-center mb-3">
              <View className="bg-orange-500/20 p-2 rounded-lg mr-3">
                <Ionicons name="flame" size={20} color="#F97316" />
              </View>
              <Text className="text-white text-lg font-bold">스파크란?</Text>
            </View>
